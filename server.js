...
const Imap = require('node-imap'); // <-- Use node-imap instead of imap
const { simpleParser } = require('mailparser');

// Directory for saving attachments
const ATTACHMENTS_DIR = path.join(__dirname, 'uploads', 'email-receipts');
...
setInterval(checkEmailInbox, 60 * 60 * 1000);
